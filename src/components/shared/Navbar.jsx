...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 z-[9999] w-full h-16 flex justify-between items-center px-36 font-Poppins font-semibold drop-shadow-2xl ${
      ...
      <div className="flex justify-between w-full items-center">
        ...
        <div className="flex lg:hidden flex-row w-1/2 justify-end items-center gap-16">
          <div className="relative flex justify-center items-center">
            ...
            {isOpen && (
              <ul className="fixed flex flex-col z-[9999] gap-1 right-32 top-16 min-w-[200px] text-center text-white justify-center items-center bg-transparent bg-opacity-40 backdrop-blur-md p-2">
                <li
